...
DATABASES = {
    'default': {
        ...
        'NAME': 'yigitdb',
        'USER': 'yigittekeler@server-yigit',
        'PASSWORD': 'yigit_cloud19',
        'HOST': 'server-yigit.postgres.database.azure.com'
    }
}
...
STATIC_ROOT = os.path.join(os.path.normpath(BASE_DIR), "gorunum")
